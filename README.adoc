...
:repo-liquidprompt: https://github.com/nojhan/liquidprompt[Liquid Prompt]
...
Wet:: Modified toasty by aditya3098, but takes heavy inspiration from {repo-liquidprompt}.
